...
class LocalSearch {
  ...
  struct FullLocalSearchCandidate {
    ...
    FullLocalSearchCandidate(const unsigned vertex, const int local_improvement, const ClusterLabels label)
  ...
  static std::vector<std::vector<int>> InitLocalImprovements(const IGraph& graph, const IClustPtr& cur_clustering);
  ...
  static FullLocalSearchCandidate FindCandidate(const IGraph& graph, const std::vector<std::vector<int>>& cache,
  ...
  static void UpdateLocalImprovements(const IGraph& graph, const IClustPtr& cur_clustering,
                                      std::vector<std::vector<int>>& cache, unsigned vertex, ClusterLabels old_label,
                                      ClusterLabels new_label);
 ...
 public:
   ...
   */
  static IClustPtr ComputeLocalOptimum(const IGraph& graph, const IClustPtr& cur_clustering, ClusterLabels first_label,
                                       ClusterLabels second_label);

  static IClustPtr ComputeLocalOptimum(const IGraph& graph, const IClustPtr& cur_clustering);

  static std::vector<int> ComputeLocalImprovement(const IGraph& graph, const IClustPtr& cur_clustering,
                                                  unsigned vertex);
};
}  // namespace non_strict_3cc
