...
class AdjacencyMatrixGraph final : public IGraph {
 ...
 public:
  ...
  explicit AdjacencyMatrixGraph(const std::vector<std::vector<bool>>& adjacency_matrix)
      : adjacency_matrix_(adjacency_matrix) {}

  [[nodiscard]] bool IsJoined(const unsigned i, const unsigned j) const override { return adjacency_matrix_[i][j]; }
