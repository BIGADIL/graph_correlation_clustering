...
ExperimentParameters::ExperimentParameters(
    std::vector<unsigned> graph_size_vector, std::vector<double> density_vector,
...
ExperimentParameters ExperimentParameters::ReadFromConfig(
  ...
  std::string error_message =
      "Missed or incorrect type of required parameter: ";
  ...
  return {
      graph_size_vector,          density_vector, distribution_vector,
