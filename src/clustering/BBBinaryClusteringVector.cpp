...
void BBBinaryClusteringVector::SetupLabelForVertex(const unsigned vertex,
  ...
  obj_func_value_increase_relatively_to_second_cluster_[vertex] = number_of_neighbours_in_non_clustered_graph_[vertex] = 0;
...
int BBBinaryClusteringVector::Bound(const unsigned record) const {
...
BBBinaryClusteringVector BBBinaryClusteringVector::Copy() const {
  return BBBinaryClusteringVector(*this);
}
