...
void non_strict_2cc::NeighborhoodWithManyLocalSearches::BestNeighborhoodClusteringThreadWorker(
    const IGraph& graph, const unsigned threadId, std::vector<Solution>& local_thread_buffer) const {
...
non_strict_2cc::NeighborhoodWithManyLocalSearches::NeighborhoodWithManyLocalSearches(
