...
IClustPtr
non_strict_2cc::NeighborhoodWithOneLocalSearch::getBestNeighborhoodClustering(
...
void non_strict_2cc::NeighborhoodWithOneLocalSearch::
...
non_strict_2cc::NeighborhoodWithOneLocalSearch::NeighborhoodWithOneLocalSearch(
...
std::vector<Solution>
non_strict_2cc::NeighborhoodWithOneLocalSearch::getAllSolutions(
    const IGraph &graph) const {
