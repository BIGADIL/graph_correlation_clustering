...
void non_strict_2cc::NeighborhoodWithOneLocalSearch::BestNeighborhoodClusteringThreadWorker(
...
std::vector<Solution> non_strict_2cc::NeighborhoodWithOneLocalSearch::getAllSolutions(const IGraph& graph) const {
  ...
  for (unsigned i = 0; i < num_threads_; i++) {
    thread_vector[i] = std::thread(&NeighborhoodWithOneLocalSearch::BestNeighborhoodClusteringThreadWorker, this,
