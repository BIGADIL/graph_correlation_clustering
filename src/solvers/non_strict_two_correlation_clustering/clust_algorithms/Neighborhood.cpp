...
IClustPtr non_strict_2cc::Neighborhood::getBestNeighborhoodClustering(
...
void non_strict_2cc::Neighborhood::BestNeighborhoodClusteringThreadWorker(
...
non_strict_2cc::Neighborhood::Neighborhood(
...
std::vector<Solution> non_strict_2cc::Neighborhood::getAllSolutions(
    const IGraph &graph) const {
  ...
  for (unsigned i = 0; i < num_threads_; i++) {
    thread_vector[i] =
        std::thread(&Neighborhood::BestNeighborhoodClusteringThreadWorker, this,
