...
non_strict_2cc::IPLSAlgorithm::IPLSAlgorithm(const unsigned iterations, const unsigned early_stop_num,
...
void non_strict_2cc::IPLSAlgorithm::OnIterationBegin() { buffer_.clear(); }
...
void non_strict_2cc::IPLSAlgorithm::TrainWorker(std::vector<Solution>& local_buffer, const unsigned thread_id,
...
void non_strict_2cc::IPLSAlgorithm::TrainWorkerLoop(std::vector<Solution>& local_buffer, const unsigned thread_id,
