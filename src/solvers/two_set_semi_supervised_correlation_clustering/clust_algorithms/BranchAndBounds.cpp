...
IClustPtr set_semi_supervised_2cc::BranchAndBounds::GetBestClustering(
    const IGraphPtr& graph, const IClustPtr& initial_clustering, const std::vector<unsigned>& first_cluster_vertices,
