...
IClustPtr set_semi_supervised_2cc::NeighborhoodWithOneLocalSearch::getBestNeighborhoodClustering(
  ...
  return LocalSearch::ComputeLocalOptimum(graph, best_neighborhood_clustering, first_cluster_vertices,
                                          second_cluster_vertices);
}

void set_semi_supervised_2cc::NeighborhoodWithOneLocalSearch::BestNeighborhoodClusteringThreadWorker(
...
set_semi_supervised_2cc::NeighborhoodWithOneLocalSearch::NeighborhoodWithOneLocalSearch(
