#include "../../../../include/solvers/two_semi_supervised_correlation_clustering/common_functions/NSplitterFor2SCC.hpp"

NSplitterFor2SCC::NSplitterFor2SCC(IClustFactoryPtr clustering_factory) :
    clustering_factory_(std::move(clustering_factory)) {
}

std::vector<IClustPtr> NSplitterFor2SCC::SplitGraphByVertex(const IGraph &graph,
                                                            unsigned int vertex,
