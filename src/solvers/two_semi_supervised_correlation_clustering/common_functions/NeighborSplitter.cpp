...
std::vector<IClustPtr> semi_supervised_2cc::NeighborSplitter::SplitGraphByVertex(
    const IGraph& graph, const unsigned int vertex, const unsigned int first_cluster_vertex,
