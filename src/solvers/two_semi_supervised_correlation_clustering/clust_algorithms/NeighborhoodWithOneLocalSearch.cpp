...
IClustPtr semi_supervised_2cc::NeighborhoodWithOneLocalSearch::getBestNeighborhoodClustering(const IGraph &graph,
  ...
  return LocalSearch::ComputeLocalOptimum(
      graph,
...
void semi_supervised_2cc::NeighborhoodWithOneLocalSearch::BestNeighborhoodClusteringThreadWorker(const IGraph &graph,
...
semi_supervised_2cc::NeighborhoodWithOneLocalSearch::NeighborhoodWithOneLocalSearch(const unsigned num_threads,
