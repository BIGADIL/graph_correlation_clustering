...
IClustPtr semi_supervised_2cc::NeighborhoodWithOneLocalSearch::
...
void semi_supervised_2cc::NeighborhoodWithOneLocalSearch::
...
semi_supervised_2cc::NeighborhoodWithOneLocalSearch::
    NeighborhoodWithOneLocalSearch(const unsigned num_threads,
