...
IClustPtr semi_supervised_2cc::Neighborhood::getBestNeighborhoodClustering(const IGraph& graph,
...
void semi_supervised_2cc::Neighborhood::BestNeighborhoodClusteringThreadWorker(
...
semi_supervised_2cc::Neighborhood::Neighborhood(const unsigned num_threads, const IClustFactoryPtr& clustering_factory)
