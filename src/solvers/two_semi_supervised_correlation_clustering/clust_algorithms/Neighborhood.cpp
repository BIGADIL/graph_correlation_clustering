...
IClustPtr semi_supervised_2cc::Neighborhood::getBestNeighborhoodClustering(
    const IGraph &graph, const unsigned first_cluster_vertex,
...
semi_supervised_2cc::Neighborhood::Neighborhood(
