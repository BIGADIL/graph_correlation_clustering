...
void semi_supervised_2cc::Neighborhood::BestNeighborhoodClusteringThreadWorker(const IGraph &graph,
...
semi_supervised_2cc::Neighborhood::Neighborhood(const unsigned num_threads,
