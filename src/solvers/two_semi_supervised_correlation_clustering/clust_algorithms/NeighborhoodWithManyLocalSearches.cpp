...
IClustPtr semi_supervised_2cc::NeighborhoodWithManyLocalSearches::getBestNeighborhoodClustering(const IGraph &graph,
...
void semi_supervised_2cc::NeighborhoodWithManyLocalSearches::BestNeighborhoodClusteringThreadWorker(const IGraph &graph,
...
semi_supervised_2cc::NeighborhoodWithManyLocalSearches::NeighborhoodWithManyLocalSearches(const unsigned num_threads,
