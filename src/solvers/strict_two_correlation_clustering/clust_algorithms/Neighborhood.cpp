...
IClustPtr strict_2cc::Neighborhood::getBestNeighborhoodClustering(
...
void strict_2cc::Neighborhood::BestNeighborhoodClusteringThreadWorker(
...
strict_2cc::Neighborhood::Neighborhood(
