...
void strict_2cc::Neighborhood::BestNeighborhoodClusteringThreadWorker(const IGraph& graph, const unsigned threadId,
...
strict_2cc::Neighborhood::Neighborhood(const unsigned num_threads, const IClustFactoryPtr& clustering_factory)
