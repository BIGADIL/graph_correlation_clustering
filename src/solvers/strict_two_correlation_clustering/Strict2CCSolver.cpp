...
std::string strict_2cc::Strict2CCSolver::solve(const IGraphPtr& graph, const double density,
...
strict_2cc::Strict2CCSolver::Strict2CCSolver(const unsigned num_threads, IClustFactoryPtr factory)
