...
void non_strict_3cc::TwoVerticesNeighborhoodWithManyLocalSearches::
...
non_strict_3cc::TwoVerticesNeighborhoodWithManyLocalSearches::
...
IClustPtr non_strict_3cc::TwoVerticesNeighborhoodWithManyLocalSearches::
...
std::vector<Solution>
non_strict_3cc::TwoVerticesNeighborhoodWithManyLocalSearches::getAllSolutions(
  ...
  for (unsigned i = 0; i < num_threads_; i++) {
    thread_vector[i] =
        std::thread(&TwoVerticesNeighborhoodWithManyLocalSearches::
                        BestNeighborhoodClusteringThreadWorker,
