...
void non_strict_3cc::TwoVerticesNeighborhood::
...
non_strict_3cc::TwoVerticesNeighborhood::TwoVerticesNeighborhood(
...
IClustPtr
non_strict_3cc::TwoVerticesNeighborhood::getBestNeighborhoodClustering(
...
std::vector<Solution> non_strict_3cc::TwoVerticesNeighborhood::getAllSolutions(
    const IGraph &graph) const {
  ...
  for (unsigned i = 0; i < num_threads_; i++) {
    thread_vector[i] = std::thread(
        &TwoVerticesNeighborhood::BestNeighborhoodClusteringThreadWorker, this,
