...
void non_strict_3cc::TwoVerticesNeighborhood::BestNeighborhoodClusteringThreadWorker(
...
non_strict_3cc::TwoVerticesNeighborhood::TwoVerticesNeighborhood(const unsigned num_threads,
...
std::vector<Solution> non_strict_3cc::TwoVerticesNeighborhood::getAllSolutions(const IGraph& graph) const {
  ...
  for (unsigned i = 0; i < num_threads_; i++) {
    thread_vector[i] = std::thread(&TwoVerticesNeighborhood::BestNeighborhoodClusteringThreadWorker, this,
