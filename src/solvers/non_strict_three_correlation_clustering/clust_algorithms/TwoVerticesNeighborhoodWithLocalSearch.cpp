...
void non_strict_3cc::TwoVerticesNeighborhoodWithLocalSearch::BestNeighborhoodClusteringThreadWorker(
...
non_strict_3cc::TwoVerticesNeighborhoodWithLocalSearch::TwoVerticesNeighborhoodWithLocalSearch(
...
IClustPtr non_strict_3cc::TwoVerticesNeighborhoodWithLocalSearch::getBestNeighborhoodClustering(
...
std::vector<Solution> non_strict_3cc::TwoVerticesNeighborhoodWithLocalSearch::getAllSolutions(
    const IGraph& graph) const {
  ...
  for (unsigned i = 0; i < num_threads_; i++) {
    thread_vector[i] = std::thread(&TwoVerticesNeighborhoodWithLocalSearch::BestNeighborhoodClusteringThreadWorker,
                                   this, std::ref(graph), i, std::ref(local_thread_buffer[i]));
  }
